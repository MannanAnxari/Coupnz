...
const Footer2 = ({ season , country , data  })=>{
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
            className: "container py-4 bg-secondary",
                    ...
                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("p", {
                                ...
                                children: _config__WEBPACK_IMPORTED_MODULE_1__.FOOTER_ABOUT
                            }),
...
const Header1 = ({ data , category , season , coupons , country  })=>{
    ...
    const handleSearch = (e)=>{
        ...
        if (e.length > 1) {
            setIsActive(true);
            setIsLoading(true);
            fetch(`${_config__WEBPACK_IMPORTED_MODULE_7__.APP_URL}api/store?key=${_config__WEBPACK_IMPORTED_MODULE_7__.APP_KEY}&search=${e}`).then((res)=>res.json()).then((results)=>{
                let query = [];
...
const Header2 = ({ data , category , season , coupons , country  })=>{
    ...
    const handleSearch = (e)=>{
        ...
        if (e.length > 1) {
            setIsActive(true);
            setIsLoading(true);
            fetch(`${_config__WEBPACK_IMPORTED_MODULE_5__.APP_URL}api/store?key=${_config__WEBPACK_IMPORTED_MODULE_5__.APP_KEY}&search=${e}`).then((res)=>res.json()).then((results)=>{
                let query = [];
                results?.data?.map((item)=>query.push({
                        name: item.name,
                        slug: item.slug
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("nav", {
                className: "navbar navbar-expand-lg bg-secondary p-3",
                children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                            className: "collapse navbar-collapse w-75 mt-2 position-relative",
                            id: "navbarSupportedContent",
...
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(1838);
...
function App({ Component , pageProps  }) {
    ...
    if (err) return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
        ...
        return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
            ...
            ]) + " " + `_element ${_config__WEBPACK_IMPORTED_MODULE_13__.CONTAINER_TYPE === "wide" ? "wide" : "none-wide"}`,
            children: [
...
var __webpack_exports__ = __webpack_require__.X(0, [210,459,664,443,675,298,152,556,321,850,498,237,988], () => (__webpack_exec__(8510)));
